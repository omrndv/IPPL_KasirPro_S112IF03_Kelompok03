        ...
        <ul class="space-y-1.5 font-medium mt-4 flex-1">
            ...
            <li class="relative">
                ...
                <a href="/transaksi"
                    ...
                    <span
                        class="inline-flex items-center justify-center px-2 py-0.5 text-[10px] font-bold text-blue-700 bg-blue-100 border border-blue-200 rounded-md">NEW</span>
                </a>
            </li>
            ...
            <li class="relative">
                ...
                @endif
                <a href="/bahan-baku"
                    class="flex items-center p-2.5 rounded-lg group transition {{ request()->is('bahan-baku') ? 'text-blue-700 bg-blue-50 font-semibold' : 'text-gray-500 hover:bg-gray-50 hover:text-gray-900 font-medium' }}">

                    <svg class="w-5 h-5 mr-3 {{ request()->is('bahan-baku') ? 'text-blue-600' : 'text-gray-400 group-hover:text-gray-600' }}"
                    ...
                    <span class="text-sm flex-1 whitespace-nowrap">Stok Bahan Baku</span>

                    <span
                        class="inline-flex items-center justify-center px-2 py-0.5 text-[10px] font-bold text-blue-700 bg-blue-100 border border-blue-200 rounded-md">PRO</span>
                </a>
            </li>
